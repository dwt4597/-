...
import com.biz.names.vo.*;

//파일 2개를 읽어서 조합으 해야 하므로
	...
	public void readFirstFile() {
		...
		try {
			...
			while (true) {
				...
				String fstName = names[1]; //한자 포함
				//일부 특수문자는 단독으로 split이
				//안되는 것들이 있다.
